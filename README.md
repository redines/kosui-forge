...
The initial `repo-bootstrap` engine creates and clones Forgejo repositories and can configure matching GitHub push mirrors. Ordinary creation is unconditionally private on both services. Configuration cannot opt into public visibility.
